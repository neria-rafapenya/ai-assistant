...
const tarotCards: TarotCard[] = [
  ...
  { id: "02-la-sacerdotisa", name: "La Sacerdotisa", image: "02_high_priestess.png", meaning: "Intuición, escucha interior y conocimiento reservado." },
  { id: "03-la-emperatriz", name: "La Emperatriz", image: "03_empress.png", meaning: "Creatividad, cuidado y crecimiento fértil." },
  { id: "04-el-emperador", name: "El Emperador", image: "04_emperor.png", meaning: "Estructura, límites y responsabilidad." },
  { id: "05-el-papa", name: "El Papa", image: "05_hierophant.png", meaning: "Aprendizaje, valores y orientación." },
  { id: "06-los-enamorados", name: "Los Enamorados", image: "06_lovers.png", meaning: "Elección, vínculo y coherencia con los propios valores." },
  { id: "07-el-carro", name: "El Carro", image: "07_chariot.png", meaning: "Dirección, voluntad y avance decidido." },
  { id: "08-la-fuerza", name: "La Fuerza", image: "08_strength.png", meaning: "Serenidad, coraje y dominio amable de la energía." },
  { id: "09-el-ermitano", name: "El Ermitaño", image: "09_hermit.png", meaning: "Pausa, introspección y búsqueda de claridad." },
  { id: "10-la-rueda", name: "La Rueda de la Fortuna", image: "10_wheel_of_fortune.png", meaning: "Cambio, ciclos y nuevas circunstancias." },
  { id: "11-la-justicia", name: "La Justicia", image: "11_justice.png", meaning: "Equilibrio, consecuencias y decisiones conscientes." },
  { id: "12-el-colgado", name: "El Colgado", image: "12_hanged_man.png", meaning: "Perspectiva, entrega y pausa necesaria." },
  { id: "13-la-muerte", name: "La Muerte", image: "13_death.png", meaning: "Transformación, cierre y renovación." },
  { id: "14-la-templanza", name: "La Templanza", image: "14_temperance.png", meaning: "Integración, paciencia y armonía." },
  { id: "15-el-diablo", name: "El Diablo", image: "15_devil.png", meaning: "Deseo, ataduras y consciencia de los patrones." },
  { id: "16-la-torre", name: "La Torre", image: "16_tower.png", meaning: "Revelación, ruptura y liberación de estructuras." },
  { id: "17-la-estrella", name: "La Estrella", image: "17_star.png", meaning: "Esperanza, inspiración y confianza renovada." },
  { id: "18-la-luna", name: "La Luna", image: "18_moon.png", meaning: "Sensibilidad, imaginación y zonas de incertidumbre." },
  { id: "19-el-sol", name: "El Sol", image: "19_sun.png", meaning: "Claridad, vitalidad y alegría compartida." },
  { id: "20-el-juicio", name: "El Juicio", image: "20_judgement.png", meaning: "Llamada interior, revisión y despertar." },
  { id: "21-el-mundo", name: "El Mundo", image: "21_world.png", meaning: "Culminación, integración y amplitud de perspectiva." },
];
